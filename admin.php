	...
	$cfct_options = array(
		'cfct' => array(
			...
			'fields' => array(
				...
				'image_select_name' => array(
					'type' => 'image_select',
					'label' => __('Image Selection', 'carrington'),
					'name' => 'image_selection',
					'select_type' => 'multiple', // multiple || single (defaults to multiple)
				),
				*/
			),
		),
...
function cfct_image_select_assets() {
	$base_url = apply_filters('cfct_extras_assets_base_url', get_template_directory_uri().'/carrington-extras/assets/');
	wp_enqueue_media();
